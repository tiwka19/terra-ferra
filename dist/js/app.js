 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".advantages__content")) {
                ...
                slideCheckbox.addEventListener("change", (() => {
                    if (slideCheckbox.checked) swiper.slideTo(1); else swiper.slideTo(0);
                }));
            }
        }
        ...
        var lazyload_min = __webpack_require__(710);
        new lazyload_min({
        ...
        var toastify = __webpack_require__(845);
        var sal = __webpack_require__(664);
        sal({
            threshold: .3
        });
            ...
            formInputs.forEach((input => {
                input.addEventListener("input", (() => {
                    const isFormFilled = Array.from(formInputs).every((input => {
                        if (input.type === "checkbox") return input.checked; else return input.value !== "";
                    }));
                    if (isFormFilled) formButton.classList.add("_active"); else formButton.classList.remove("_active");
                }));
            }));
        }));
